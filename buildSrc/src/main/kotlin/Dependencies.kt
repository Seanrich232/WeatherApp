...
object Dependencies {
    ...
    object Lifecycle {
        ...
        const val lifecycleJava = "androidx.lifecycle:lifecycle-common-java8:2.2.0"
    ...
    object DependencyInjection {
        const val daggerHilt = "com.google.dagger:hilt-android:2.28.1-alpha"
        const val viewModelHilt = "androidx.hilt:hilt-lifecycle-viewmodel:1.0.0-alpha01"
        const val daggerHiltK = "com.google.dagger:hilt-android-compiler:2.28.1-alpha"
        const val compHilt = "androidx.hilt:hilt-compiler:1.0.0-alpha01"
    }
    ...
    fun DependencyHandler.implementationLifecycle() {
        add("implementation", Lifecycle.lifecycleExtensions)
        add("implementation", Lifecycle.lifecycleJava)
        add("implementation", Lifecycle.lifecycleViewModel)
        add("implementation", Lifecycle.lifecycleLiveData)
    }
    ...
    fun DependencyHandler.implementationDependencyInjection() {
        add("implementation", DependencyInjection.daggerHilt)
        add("implementation", DependencyInjection.viewModelHilt)
        add("kapt", DependencyInjection.daggerHiltK)
        add("kapt", DependencyInjection.compHilt)
    }
    ...
    fun DependencyHandler.implementationTimber() {
        add("implementation", Timber.timber)
    }
}